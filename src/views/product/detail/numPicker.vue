...
<style scoped>
  .picker { display: flex; box-sizing: border-box; border: 1PX solid #d9d9d9; text-align: center; font-size: 0;height: 34px; }
  .picker i { width: 32px; height: 32px; line-height: 32px; font-size: 20px; }
  .picker i.disabled { color: #858585; }
  input { width: 40px; height: 32px; background: #fff; color: #000; border: none; text-align: center;}
  .minus { border-right: 1px solid #d9d9d9; }
  .plus { border-left: 1px solid #d9d9d9; }
</style>
<template>
  <div class="picker">
